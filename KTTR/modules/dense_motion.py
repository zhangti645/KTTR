...
class DenseMotionNetwork(nn.Module):
    ...
    def __init__(self, block_expansion, num_blocks,num_down_blocks, max_features, num_kp, num_channels, num_bottleneck_blocks, 
                 scale_range, estimate_occlusion_map=False, kp_variance=0.01):
    ...
    def forward(self, scalefactor, source_image,heatmap_source, heatmap_driving, source_image_more = None, heatmap_source_more = None):
        # if self.scale_factor != 1:

...
class KPDetector(nn.Module):
    ...
    def __init__(self, block_expansion, num_kp, num_channels, num_ref, num_temporal,scale_range,max_features,
...
#         return out    
    ...
    def forward(self, x, scalefactor):
        ...
        multiscale_perceptural_representation = {'per_32':prediction_gdn1,'per_16':prediction_gdn2,'per_8':prediction_gdn3,'per_4':prediction}
        return out, multiscale_perceptural_representation    
